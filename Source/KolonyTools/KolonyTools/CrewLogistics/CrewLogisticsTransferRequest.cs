    ...
    public class OrbitalLogisticsTransferRequest : IConfigNode, IComparable<OrbitalLogisticsTransferRequest>
    {
        ...
        public void CalculateDuration()
        {
            ...
            if (sourceSituation == (sourceSituation & SURFACE) && targetSituation == (targetSituation & SURFACE))
            {
                ...
                double velocity = LogisticsExtensions.OrbitalVelocity(mainBody, mainBody.minOrbitalDistance + mainBody.Radius);
                double period = LogisticsExtensions.OrbitalPeriod(mainBody, mainBody.minOrbitalDistance + mainBody.Radius);
            ...
            )
            {
                ...
                double period = sourceSituation == Vessel.Situations.ORBITING
                    ...
                    : LogisticsExtensions.OrbitalPeriod(mainBody, targetProtoVessel.orbitSnapShot.semiMajorAxis);
            ...
            else if (sourceSituation == Vessel.Situations.ORBITING && targetSituation == Vessel.Situations.ORBITING)
            {
                ...
                double highOrbitPeriod = LogisticsExtensions.OrbitalPeriod(mainBody, highOrbitSMA);
                double lowOrbitPeriod = LogisticsExtensions.OrbitalPeriod(mainBody, lowOrbitSMA);
        ...
        public float CalculateFuelUnits()
        {
            ...
            if (sourceSituation == (sourceSituation & SURFACE) && targetSituation == (targetSituation & SURFACE))
            {
                ...
                double orbitV = LogisticsExtensions.OrbitalVelocity(mainBody, mainBody.minOrbitalDistance + mainBody.Radius);
            ...
            else
            {
                ...
                else if (sourceSituation == Vessel.Situations.ORBITING && targetSituation == Vessel.Situations.ORBITING)
                {
                    ...
                    double highOrbitV = LogisticsExtensions.OrbitalVelocity(mainBody, highOrbitSMA);
                    double lowOrbitV = LogisticsExtensions.OrbitalVelocity(mainBody, lowOrbitSMA);
                    ...
                    if (dSMA < 10000)
                    {
                        ...
                        transferV = highOrbitV - LogisticsExtensions.OrbitalVelocity(mainBody, highOrbitSMA + 30000);
                    }
